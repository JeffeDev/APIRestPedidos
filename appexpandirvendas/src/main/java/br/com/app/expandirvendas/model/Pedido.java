...
public class Pedido {
	...
	public Pedido(Long id_pedi, Long numeroPedido_pedi, Long cliente_id, String dataEmissao_pedi,
			...
			List<ItensPedido> pedidoItens_pedi) {
		super();
		...
		this.statusPedido_pedi = statusPedido_pedi;
		this.pedidoItens_pedi = pedidoItens_pedi;
	}
	...
	public String toString() {
		return "Pedido [id_pedi=" + id_pedi + ", numeroPedido_pedi=" + numero_pedi + ", cliente_id=" + cliente_id
				...
				+ ", totalPedido_pedi=" + totalPedido_pedi + ", statusPedido_pedi=" + statusPedido_pedi
				+ ", pedidoItens_pedi=" + pedidoItens_pedi + "]";
	}
	...
	public PedidoStatusEnum getStatusPedido_pedi() {
		return statusPedido_pedi;
	}

	public List<ItensPedido> getPedidoItens_pedi() {
		return pedidoItens_pedi;
	}
